...
val DailyDigitalLegendLabelKey = ExtraStore.Key<Set<String>>()
val DailyDigitalX = (2008..2018).toList()
val DailyDigitalY =
    mapOf(
    ...
    CartesianChartHost(
        chart = rememberCartesianChart(
            ...
            legend = rememberHorizontalLegend(
                items = { extraStore ->
                    extraStore[DailyDigitalLegendLabelKey].forEachIndexed { index, label ->
                        add(
                            LegendItem(
